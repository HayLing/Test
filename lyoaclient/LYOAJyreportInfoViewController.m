//
//  LYOAJyreportInfoViewController.m
//  lyoaclient
//
...
#import "LYOAJyreportInfoViewController.h"
...
@interface LYOAJyreportInfoViewController ()

@end

@implementation LYOAJyreportInfoViewController
...
-(void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    if(alertView == alert2){
        if([[alertView buttonTitleAtIndex:buttonIndex] isEqualToString:@"确定"]){
            [self performSegueWithIdentifier:@"jobgofileview" sender:self];
        }
    }
